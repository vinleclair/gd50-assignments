...
gSounds = {
    ...
    ['key-pickup'] = love.audio.newSource('sounds/key-pickup.wav', 'static'),
    ['gem-pickup'] = love.audio.newSource('sounds/gem-pickup.wav', 'static'),
    ...
    ['flag-touch'] = love.audio.newSource('sounds/flag-touch.wav', 'static'),
    ['flag-wave'] = love.audio.newSource('sounds/flag-wave.wav', 'static')
}
