...
function PlayState:update(dt)
    -- TODO Remove debugging player commands
...
function PlayState:render()
    ...
    if self.player.key then
        love.graphics.draw(gTextures['keys'], gFrames['keys'][self.player.key], 4, 15)
    end

    -- TODO Remove onscreen x, y debugging coordinates
    love.graphics.setFont(gFonts['small'])
    love.graphics.print("x:" .. tostring(math.floor(self.player.x)), 50, 1)
    love.graphics.print("y:" .. tostring(math.floor(self.player.y)), 150, 1)
    end
