            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local HLTIncrease, ATKIncrease, DEFIncrease, SPDIncrease = self.playerPokemon:levelUp()

                        local levelUpMessage = 'Congratulations! Level Up!\n' ..
                                'HP: ' .. self.playerPokemon.HP - HLTIncrease .. ' + ' .. HLTIncrease .. ' = ' .. self.playerPokemon.HP .. '\n' ..
                                'ATK: ' .. self.playerPokemon.attack - ATKIncrease .. ' + ' .. ATKIncrease .. ' = ' .. self.playerPokemon.attack .. '\n' ..
                                'DEF: ' .. self.playerPokemon.defense - DEFIncrease .. ' + ' .. DEFIncrease .. ' = ' .. self.playerPokemon.defense .. '\n' ..
                                'SPD: ' .. self.playerPokemon.speed - SPDIncrease .. ' + ' .. SPDIncrease .. ' = ' .. self.playerPokemon.speed .. '\n'

                        gStateStack:push(BattleMessageState(levelUpMessage,
                                function()
                                    self:fadeOutWhite()
                                end))
                    else
