...
function LevelMaker.createMap(level)
    ...
    -- randomly choose the number of locked bricks
    local numLockedBricks = math.random(0, 3)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            if math.random(1, 20) == 1 and numLockedBricks > 0 then
                b.locked = true
                numLockedBricks = numLockedBricks - 1
            end
